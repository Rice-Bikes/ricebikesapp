...
export class UserParagraphNode extends ParagraphNode {
    ...
    decorate(): JSX.Element | null {
        try {
            ...
            // Debug: log when decorate is called in runtime
            try {
                console.log('[UserParagraphNode] decorate called', { key, attribution: this.__attribution });
            } catch {
                // ignore logging errors
            }
            return <AttributionChip nodeKey={key} />;
        } catch (e) {
            try {
                console.log('[UserParagraphNode] decorate error', e);
            } catch {
                // ignore
            }
            return null;
