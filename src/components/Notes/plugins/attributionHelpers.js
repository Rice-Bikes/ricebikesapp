// Lightweight runtime helper that attaches attribution helpers to any editor-like object.
// This file is plain JS so it can be imported and exercised by a Node script without TS
// compilation.
