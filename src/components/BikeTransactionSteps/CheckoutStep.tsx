...
export const CheckoutStep: React.FC<CheckoutStepProps> = ({
  ...
  const [reservedCustomer, setReservedCustomer] = useState<Customer | null>(
    null,
  );
  ...
  const handleReservationComplete = async (
    customer: Customer,
    reservationDetails: { deposit_amount: number; bike_id: string },
  ) => {
    ...
    console.log(
      "Reservation completed for customer:",
      customer,
      "with deposit:",
      reservationDetails.deposit_amount,
    );
  };
            ...
            <Box>
              ...
              <CustomerReservation
                ...
                onCustomerAssigned={(customer) =>
                  handleReservationComplete(customer, {
                    deposit_amount: bike?.deposit_amount || 0,
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell align="right">
                  <strong>${(bikePrice + tax).toFixed(2)}</strong>
                </TableCell>
              </TableRow>
              {
                <TableRow>
