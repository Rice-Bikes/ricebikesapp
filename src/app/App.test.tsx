...
vi.mock("../features/TransactionsTable/TransactionsTable", () => ({
  TransactionsTable: () => (
    <div data-testid="transactions-table">Mock Transactions Table</div>
  ),
}));
...
vi.mock("../features/TransactionPage/TransactionPage", () => ({
  default: () => (
    <div data-testid="transaction-detail">Mock Transaction Detail</div>
  ),
}));
...
describe("App Component", () => {
  ...
  test("renders header elements", () => {
    ...
    expect(screen.getByText("All bikes")).toBeInTheDocument();
  });
  ...
  test.skip("handles logout action", async () => {
    // Arrange
  ...
  test.skip("navigation works when clicking Rice Bikes icon", () => {
