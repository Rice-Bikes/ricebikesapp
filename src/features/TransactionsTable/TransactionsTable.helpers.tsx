  ...
  return [
    {
      ...
      valueGetter: (params: ICellRendererParams<IRow>) =>
        params.data?.Transaction.transaction_num,
      filter: true,
    } as ColDef<IRow>,
    {
      headerName: "Status",
    ...
    },
    {
      ...
      valueGetter: (params: ICellRendererParams<IRow>) =>
        params.data?.Transaction?.transaction_id,
...
export const checkStatusOfRetrospec = (
  refurb?: boolean,
  email?: boolean,
  completed?: boolean,
) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ width: "100%", height: "100%", background: "#2e7d32" }}
            />
          </div>
        </div>
